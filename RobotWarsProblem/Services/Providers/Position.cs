using RobotWarsProblem.Models.Enums;
using RobotWarsProblem.Services.Interfaces;
using System;

namespace RobotWarsProblem.Services.Repositories
{
    public class Position : IPosition
    {
        ...
        public void StartMoving(List<int> maxPoints, string moves)
        {
            foreach (var move in moves)
            {
                ...
                {
                    throw new Exception($"Beyound Boundaries (0 , 0) and ({maxPoints[0]} , {maxPoints[1]})");
                }
            }
        }
